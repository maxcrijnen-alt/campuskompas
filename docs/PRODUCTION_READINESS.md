...
- De sectie Evenementen in de buurt wordt vanuit één dataset op `Europe/Amsterdam` gefilterd en chronologisch getoond. Verlopen en geannuleerde evenementen verdwijnen uit de standaardlijst; canonical source-URL voorkomt dubbelen. Op 2026-09-17 zijn 9 actieve evenementen opgenomen. The Grave Rave en Friesland Pop Pizza Party staan als geannuleerd geregistreerd en worden niet als actief getoond.
